(function(global, factory) {
  ...
  reduxThunk =
    reduxThunk && Object.prototype.hasOwnProperty.call(reduxThunk, 'default')
      ? reduxThunk['default']
      : reduxThunk;
  memoizerific =
    memoizerific &&
    Object.prototype.hasOwnProperty.call(memoizerific, 'default')
      ? memoizerific['default']
      : memoizerific;
  isPlainObject =
    isPlainObject &&
    Object.prototype.hasOwnProperty.call(isPlainObject, 'default')
      ? isPlainObject['default']
      : isPlainObject;
  debounce =
    debounce && Object.prototype.hasOwnProperty.call(debounce, 'default')
      ? debounce['default']
      : debounce;
    ...
    return function() {
      return new Promise(function(resolve, reject) {
        references.internals.persistenceConfig.forEach(function(_ref2) {
          ...
          var targets = resolvePersistTargets(
            persistRoot,
            whitelist,
            blacklist,
          );
  ...
  function createThunkHandler(
    ...
    return function(payload) {
      ...
      return thunkDefinition(
        get(meta.parent, actionCreators),
        payload,
        helpers,
      );
    };
